...
async function loadModels() {
  ...
  try {
    ...
    AppState.connectorModel = await loadOBJ(loader, "https://3dfiles.sm0l.dev/connector.obj");
    console.log("✓ Connector OBJ loaded");

    // Load connector-pins.obj (optional)
    try {
      updateLoadingProgress(80, "Loading pogo pins...");
      AppState.pinsModel = await loadOBJ(loader, "https://3dfiles.sm0l.dev/connector-pins.obj");
